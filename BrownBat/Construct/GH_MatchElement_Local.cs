...
{
    public class GH_MatchElement_Local : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_Param class.
        /// </summary>
        public GH_MatchElement_Local()
          : base("WIP_MatchElement_Local", "ML",
              "Match local design elements to origin",
              "BrownBat", "Construct")
        {
        }
        ...
        {
            get { return new Guid("0c839475-6813-46b8-b592-28b30396a098"); }
        }
    }
}